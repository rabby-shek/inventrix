...
<aside id="sidebar" class="fixed top-0 left-0 h-full bg-white border-r border-gray-200 z-50 transition-all duration-300 sidebar-expanded flex flex-col">
    ...
    <nav class="flex-1 overflow-y-auto py-4 px-3">
        <ul class="space-y-1">
            <li>
                <a href="{{ route('dashboard') }}" class="sidebar-item sidebar-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-gray-600 hover:bg-gray-100 hover:text-gray-900 transition-colors {{ request()->routeIs('dashboard') ? 'active' : '' }}">
            ...
            <li>
                <button class="sidebar-item flex items-center gap-3 px-3 py-2.5 rounded-lg text-gray-600 hover:bg-gray-100 hover:text-gray-900 transition-colors w-full text-left" data-toggle="purchase" data-active-route="{{ request()->routeIs('purchase-orders') || request()->routeIs('suppliers') ? '1' : '0' }}">
            ...
            <li>
                <button class="sidebar-item flex items-center gap-3 px-3 py-2.5 rounded-lg text-gray-600 hover:bg-gray-100 hover:text-gray-900 transition-colors w-full text-left" data-toggle="people" data-active-route="{{ request()->routeIs('customers') || request()->routeIs('suppliers') ? '1' : '0' }}">
            ...
            <li>
                <button class="sidebar-item flex items-center gap-3 px-3 py-2.5 rounded-lg text-gray-600 hover:bg-gray-100 hover:text-gray-900 transition-colors w-full text-left" data-toggle="user-management" data-active-route="{{ request()->routeIs('users') || request()->routeIs('roles') ? '1' : '0' }}">
                    <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"/></svg>
            ...
            <li>
                <a href="{{ route('settings') }}" class="sidebar-item sidebar-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-gray-600 hover:bg-gray-100 hover:text-gray-900 transition-colors {{ request()->routeIs('settings') ? 'active' : '' }}">
    ...
    <div class="p-3 border-t border-gray-200">
        <button id="sidebarToggle" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-gray-500 hover:bg-gray-100 hover:text-gray-700 transition-colors w-full">
