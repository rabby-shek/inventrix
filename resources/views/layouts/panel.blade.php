...
<head>
    ...
    <style>
        ...
        .sidebar-link.active, .sidebar-item[data-toggle].active { background-color: #eef2ff; color: #4f46e5; }
        .sidebar-submenu { max-height: 0; overflow: hidden; transition: max-height 0.3s ease; }
        .sidebar-submenu.open { max-height: 500px; }
        .menu-arrow { transition: transform 0.2s ease; display: inline-flex; }
        ...
        .sidebar-collapsed .submenu-item { justify-content: center; padding-left: 0; padding-right: 0; }
        ...
        @media (max-width: 768px) {
            ...
            .topbar-expanded, .topbar-collapsed { left: 0; }
        }
    </style>
</head>
<body class="bg-gray-100 min-h-screen">
    ...
    <div id="topbar" class="fixed top-0 right-0 h-16 bg-white border-b border-gray-200 z-30 transition-all duration-300 flex items-center justify-between px-6 topbar-expanded">
        ...
        <div class="flex items-center gap-4">
            <div class="relative">
                <button id="notifBtn" class="relative text-gray-500 hover:text-gray-700 p-2 rounded-lg hover:bg-gray-100 transition-colors">
                ...
                <div id="notifDropdown" class="hidden absolute right-0 mt-2 w-80 bg-white rounded-xl shadow-lg border border-gray-200 z-50">
                    ...
                    <a href="#" class="block text-center text-sm text-indigo-600 hover:text-indigo-500 font-medium py-3 border-t border-gray-100">View all notifications</a>
                </div>
            </div>

            <div class="relative">
                <button id="userMenuBtn" class="flex items-center gap-3 text-gray-700 hover:text-gray-900 p-1.5 pr-3 rounded-lg hover:bg-gray-100 transition-colors">
                    <div class="w-8 h-8 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-full flex items-center justify-center text-white text-sm font-medium shadow-sm">U</div>
                    <span class="hidden sm:block text-sm font-medium">User</span>
                    <svg class="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/></svg>
                </button>
                <div id="userDropdown" class="hidden absolute right-0 mt-2 w-56 bg-white rounded-xl shadow-lg border border-gray-200 z-50 overflow-hidden">
                    ...
                    <div class="py-1">
                        ...
                        <a href="{{ route('settings') }}" class="flex items-center gap-3 px-4 py-2.5 text-sm text-gray-700 hover:bg-gray-50 transition-colors">
