...
@section('content')
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div onclick="openCategoryModal()"
            class="bg-white rounded-xl shadow-sm border-2 border-dashed border-gray-200 p-5 flex items-center justify-center hover:border-indigo-300 hover:bg-indigo-50/30 transition-colors cursor-pointer">
        ...
        <form class="relative bg-white rounded-2xl shadow-xl w-full max-w-md transform transition-all"
            ...
            <div class="px-5 py-5 space-y-4">
                ...
                {{-- <div>
                    ...
                    <select
                        class="w-full px-4 py-2.5 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition-colors bg-white appearance-none">
